...
model1.add(Flatten(name='FC'))
# 
model1.add(Dropout(0.5))
model1.add(Dense(2, activation = 'softmax', name='dense'))
res.trainable = False
model1.summary()
...
hist = model1.fit(x=X_p, y=y_p, batch_size=32, epochs=32, verbose=1, callbacks=None, validation_split=0.2, validation_data=None, shuffle=True, class_weight=None, sample_weight=None, initial_epoch=0, steps_per_epoch=None, validation_steps=None)
